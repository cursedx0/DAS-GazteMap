    ...
    public Result doWork() {
        ...
        if(getInputData().getString("accion")!=null){ //código función
            ...
            switch (accion){
                ...
                case "editar": //verificar usuario, para inicio de sesión
                    //POST
                    HttpURLConnection urlConnectionEdit = null;
                    URL destinoEdit = null;
                    try {
                        destinoEdit = new URL(direccion);
                        urlConnectionLogin = (HttpURLConnection) destinoEdit.openConnection();
                        urlConnectionLogin.setConnectTimeout(5000);
                        urlConnectionLogin.setReadTimeout(5000);
                        urlConnectionLogin.setRequestMethod("POST");
                        urlConnectionLogin.setDoOutput(true);
                ...
                case "buscar_personas": //verificar usuario, para inicio de sesión
                    //POST
                    HttpURLConnection urlConnectionBP = null;
                    URL destinoBP = null;
                    try {
                        destinoBP = new URL(direccion);
                        urlConnectionLogin = (HttpURLConnection) destinoBP.openConnection();
                        urlConnectionLogin.setConnectTimeout(5000);
                        urlConnectionLogin.setReadTimeout(5000);
                        urlConnectionLogin.setRequestMethod("POST");
                        urlConnectionLogin.setDoOutput(true);
                        ...
                        if (paramsValidos) {
                            ...
                            if (responseCode == HttpURLConnection.HTTP_OK) {
                                ...
                                return Result.success(new Data.Builder()
                                        .putString("message", mensaje)
                                        .putString("code", codigo)
                                        .putString("personas",amigosArray != null ? amigosArray.toString() : "[]")
                                        .build());
                            } else {
                                Log.e("ERROR", "Error en la solicitud: " + responseCode);
                                return Result.failure();
                ...
                case "enviar_soli": //verificar usuario, para inicio de sesión
                    //POST
                    HttpURLConnection urlConnectionES = null;
                    URL destinoES = null;
                    try {
                        destinoES = new URL(direccion);
                        urlConnectionLogin = (HttpURLConnection) destinoES.openConnection();
                        urlConnectionLogin.setConnectTimeout(5000);
                        urlConnectionLogin.setReadTimeout(5000);
                        urlConnectionLogin.setRequestMethod("POST");
                        urlConnectionLogin.setDoOutput(true);
                        ...
                        if(getInputData().getString("usuario")!=null && getInputData().getString("usuarioSolicitado")!=null){
                            jsonParam.put("usuario", getInputData().getString("usuario"));
                            jsonParam.put("usuarioSolicitado", getInputData().getString("usuarioSolicitado"));
                            paramsValidos = true;
                        }
                ...
                case "obtener_solis": //verificar usuario, para inicio de sesión
                    //POST
                    HttpURLConnection urlConnectionSolis = null;
                    URL destinoSolis = null;
                    try {
                        destinoSolis = new URL(direccion);
                        urlConnectionLogin = (HttpURLConnection) destinoSolis.openConnection();
                        urlConnectionLogin.setConnectTimeout(5000);
                        urlConnectionLogin.setReadTimeout(5000);
                        urlConnectionLogin.setRequestMethod("POST");
                        urlConnectionLogin.setDoOutput(true);
                        ...
                        if (paramsValidos) {
                            ...
                            if (responseCode == HttpURLConnection.HTTP_OK) {
                                ...
                                String codigo = respuestaJson.optString("code", "-1");
                                String nombre = respuestaJson.optString("nombre", "error");
                                JSONArray amigosArray = respuestaJson.optJSONArray("solis");
                                ...
                                return Result.success(new Data.Builder()
                                        ...
                                        .putString("code", codigo)
                                        .putString("nombre", nombre)
                                        .putString("solis",amigosArray != null ? amigosArray.toString() : "[]")
                                        .build());
                            } else {
                                Log.e("ERROR", "Error en la solicitud: " + responseCode);
                                return Result.failure();
